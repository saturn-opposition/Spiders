...
class Weibo(object):
    ...
    def get_filepath(self, type):
        ...
        try:
            ...
            )[0] + os.sep + 'weibo111' + os.sep + self.user['screen_name']
...
def main():
    try:
        ...
        since_date = '2020-02-27'  # 起始时间，即爬取发布日期从该值到现在的微博，形式为yyyy-mm-dd
        ...
        user_id_list = ['5053469079','2803301701','2328516855','3494982177','3549916270','3908755088','3937348351','5078700027']
